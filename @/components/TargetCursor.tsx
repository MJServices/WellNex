...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    ...
    if (hideDefaultCursor) {
      ...
      // Add a style tag to ensure all elements have cursor none
    ...
    return () => {
      ...
      // Remove the cursor hiding style tag
      const styleTag = document.getElementById("target-cursor-hide");
      if (styleTag) {
        styleTag.remove();
      }
    };
  ...
  return (
    ...
    >
      ...
      {/* Corner brackets */}
      <div
        className="target-cursor-corner absolute"
        style={{
          willChange: "transform",
          width: "16px",
          height: "16px",
          borderTop: "3px solid #00f6ff",
          borderLeft: "3px solid #00f6ff",
          left: "-24px",
          top: "-24px",
